class FeeSavingAccount:
    def __init__(self, pin=200499, interestRate=0.25, feeSaving = 1.0):
        self.pin = pin
        self.balance = 0
        self.interestRate = interestRate
        self.feeSaving = feeSaving
    ...
    def display(self):
        print("\n Net Available Balance=", self.balance - self.feeSaving)
